...
export default function UserOverviewHistoryDetailPage() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-8">
      <Card
        title={<span className="text-lg font-bold flex items-center gap-2"><HistoryOutlined /> User History Detail</span>}

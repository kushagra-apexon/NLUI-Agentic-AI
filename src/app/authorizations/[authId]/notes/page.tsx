...
const mockNotes = [
  {
    ...
    content: "Authorization approved for MRI scan",
  ...
  },
  {
    id: "NOTE003",
    author: "Admin User",
    content: "Authorization denied - insufficient medical necessity",
...
export default function AuthorizationNotesPage() {
  const columns = [
    {
      title: 'Note ID',
      dataIndex: 'id',
  ...
  return (
    <div className="p-6">
      <Card
        title={<span className="text-lg font-bold flex items-center gap-2"><FileTextOutlined /> Authorization Notes</span>}
